...
let FirebaseService = class FirebaseService {
    constructor() {
        this.admin = firebase_admin_1.default.initializeApp({ credential: firebase_admin_1.default.credential.cert(`${process.cwd()}/serviceAccount.json`) });
    }
    async sendNotification(multicastMessage) {
