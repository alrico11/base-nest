...
export class NoteController {
  ...
  @ApiOperation({ operationId: 'CreateOrganizationProjectNote' })
  @Post()
  ...
  @ApiOperation({ operationId: 'FindAllOrganizationProjectNote' })
  @Get()
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ operationId: 'UpdateOrganizationProjectNote' })
  @Patch(':id')
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ operationId: 'DeleteOrganizationProjectNote' })
  @Delete(':id')
