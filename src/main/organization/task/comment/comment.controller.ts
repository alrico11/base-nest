...
@Controller('organization/:organizationId/task/:taskId/comment')
export class CommentController {
  constructor(private readonly commentService: CommentService) { }

  @HttpCode(HttpStatus.CREATED)
  @ApiOperation({ operationId: 'CreateOrganizationTaskComment' })
  @Post()
  ...
  @ApiOperation({ operationId: 'FindAllOrganizationTaskComment' })
  @Get()
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ operationId: 'UpdateOrganizationTaskComment' })
  @Patch(':id')
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ operationId: 'DeleteOrganizationTaskComment' })
  @Delete(':id')
